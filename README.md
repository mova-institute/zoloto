...
1. синт
    ...
    1. [UD](http://universaldependencies.org)
        ...
        1. [репорт валідатора всіх мов](http://quest.ms.mff.cuni.cz/udvalidator/cgi-bin/unidep/validation-report.pl)
        1. [репорт валідатора наш](http://quest.ms.mff.cuni.cz/udvalidator/cgi-bin/unidep/validation-report.pl?UD_Ukrainian-IU)
        1. [архів розсилки](https://cl.lingfil.uu.se/pipermail/ud/)
